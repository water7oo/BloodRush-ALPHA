...
@export var knockback_direction_default: Vector3 = Vector3(0, 0, 1)
...
@export var DefaultenemyTargetMagnitude: float = .07
@export var DefaultenemyTargetHitStop: float = .3
